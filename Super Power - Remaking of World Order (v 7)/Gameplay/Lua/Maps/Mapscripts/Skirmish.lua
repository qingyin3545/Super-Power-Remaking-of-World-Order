...
function AssignStartingPlots:PlaceStrategicAndBonusResources()
	...
	-- Even More Resources for VP end
		...
		self:ProcessResourceList(24 * bonus_multiplier, ImpactLayers.LAYER_BONUS, self.rice_list, resources_to_place)
		
		resources_to_place = {
		{self.maize_ID, 1, 100, 0, 2} };
		self:ProcessResourceList(36 * bonus_multiplier, ImpactLayers.LAYER_BONUS, self.maize_list, resources_to_place)
