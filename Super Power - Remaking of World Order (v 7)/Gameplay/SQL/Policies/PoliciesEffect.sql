...
INSERT INTO Policy_EraSettlerProductionModifier(PolicyType, EraType, Modifier)
SELECT 'POLICY_COLLECTIVE_RULE', Type, 50 FROM Eras 
WHERE ID >= (SELECT ID FROM Eras WHERE Type = 'ERA_RENAISSANCE');
