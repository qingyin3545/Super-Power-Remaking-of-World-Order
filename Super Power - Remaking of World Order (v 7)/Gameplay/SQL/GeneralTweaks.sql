...
INSERT INTO PromotionPedias (Type, Description) VALUES
('PEDIA_MELEE', 'TXT_KEY_PROMOTIONS_SECTION_1'),
('PEDIA_RANGED', 'TXT_KEY_PROMOTIONS_SECTION_2'),
('PEDIA_NAVAL', 'TXT_KEY_PROMOTIONS_SECTION_3'),
('PEDIA_HEAL', 'TXT_KEY_PROMOTIONS_SECTION_4'),
('PEDIA_SCOUTING', 'TXT_KEY_PROMOTIONS_SECTION_5'),
('PEDIA_AIR', 'TXT_KEY_PROMOTIONS_SECTION_6'),
('PEDIA_SHARED', 'TXT_KEY_PROMOTIONS_SECTION_7'),
('PEDIA_ATTRIBUTES', 'TXT_KEY_PROMOTIONS_SECTION_8');