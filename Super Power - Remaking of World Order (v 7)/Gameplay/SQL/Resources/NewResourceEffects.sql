UPDATE Resources SET TechImproveable = TechCityTrade; -- Enable when CP
UPDATE Resources SET CreateResouceWightModifier = -100 WHERE Type = 'RESOURCE_CONSUMER' OR Type = 'RESOURCE_MANPOWER'; -- Enable when CP
